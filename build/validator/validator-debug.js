...
(function()
{
    ...
    function _BaseInputField(){
        ...
        this.set('onChangeEvent', new YU.CustomEvent('onChangeEvent'));
    }
    ...
    Y.extend(_BaseInputField,validator.ValidatorBase,{
        /**
        ...
        synchronize:function(el){
            var attributes = this.getATTRS(),value,key;
    ...
    validator.BaseInputField = _BaseInputField;
})();
...
(function()
{
    ...
    _TextBaseField.ATTRS = {
        ...
        regex:{
            value:null,
            setter:validator.BaseInputField.staticFunctions.standardRegexSetter
        },
        /**
        ...
        textType:{
            ...
            setter:function(val){
                if (val === null || val === undefined){
                    ...
                    this.field.set('regex',validator.BaseInputField.staticVariables.EMAILREGEX);
                }
                else if (val.toLowerCase() == 'phone'){
                    this.field.set('regex',/^([(]?[2-9]\d{2}[)]?)[ ]*-?[ ]*(\d{3})[ ]*-?[ ]*(\d{4})$/);
                }
                else if (val.toLowerCase() == 'creditcard'){
                    this.field.set('regex',/[0-9]{4} {0,1}[0-9]{4} {0,1}[0-9]{4} {0,1}[0-9]{4}/);
                }
                else if (val.toLowerCase() == 'zipcode'){
                    this.field.set('regex',/^(\d{5})([\s]*-[\s]*\d{4})?$/);
                }
                else if (val.toLowerCase() == 'postalcode'){
                    this.field.set('regex',/^[a-zA-Z]{1}[0-9]{1}[a-zA-Z]{1}[\s]*[0-9]{1}[a-zA-Z]{1}[0-9]{1}$/);
                }
                return val;
            }
        },
        /**
         * This is the main input DOM that the validator will check input on.  This can be set as the id of the
         * object, or as the dom object itself.
         * @config inputDOM
    ...
    Y.extend(_TextBaseField,validator.BaseInputField,{
        /**
        ...
        showCorrectIndicator:function(){
            ...
            this.checkFormat();
            YD.removeClass(inputDom,this.get('incorrectCss'));
            YD.addClass(inputDom,this.get('correctCss'));
        ...
        showIncorrectIndicator:function(){
            ...
            correctIndicator = this.get('correctIndicator'),
            incorrectIndicator = this.get('incorrectIndicator');
            YD.addClass(inputDom,this.get('incorrectCss'));
            YD.removeClass(inputDom,this.get('correctCss'));
            if (correctIndicator !== null && correctIndicator !== undefined){
         ...
         */
        insertBeside:function(el) {
            YD.insertAfter(el,this.get('inputDOM'));
        },
        /**
        ...
        initializeEvents:function(target){
            ...
            YE.addListener(this.get('inputDOM'),'keyup',theTarget._evtOnChange,theTarget,true);
            YE.addListener(this.get('inputDOM'),'blur',theTarget._evtOnChange,theTarget,true);
        }
    });
    validator.TextBaseField = _TextBaseField;
}());
...
(function()
{
    ...
    _GroupBaseField.ATTRS = {
         ...
         * the id of the dom object, or the dom object itself.
         * @config groupDOM
         * @type HTMLElement|string
         */
        groupDOM:{
        ...
        maxValid:{
            ...
            setter:function(val){
                ...
                var min = this.field.get('minValid');
    ...
    Y.extend(_GroupBaseField,validator.BaseInputField,{
        /**
        ...
        showCorrectIndicator:function(){
            ...
            incorrectIndicator = this.get('incorrectIndicator');
            if (groupDom !== null && groupDom !== undefined){
                YD.removeClass(groupDom,this.get('incorrectCss'));
                YD.addClass(groupDom,this.get('correctCss'));
            }
            if (correctIndicator !== null && correctIndicator !== undefined){
                correctIndicator.style.display = '';
            }
        ...
        showIncorrectIndicator:function(){
            ...
            incorrectIndicator = this.get('incorrectIndicator');
            if (groupDom !== null && groupDom !== undefined){
                YD.addClass(groupDom,this.get('incorrectCss'));
                YD.removeClass(groupDom,this.get('correctCss'));
            }
            if (correctIndicator !== null && correctIndicator !== undefined){
                correctIndicator.style.display = 'none';
            }
    ...
    validator.GroupBaseField = _GroupBaseField;
}());
...
(function()
{
    ...
    Y.extend(_SelectField,validator.TextBaseField,{
        /**
        ...
        initializeEvents:function(target){
            ...
            YE.addListener(this.get('inputDOM'),'change',theTarget._evtOnChange,theTarget,true);
        }
    });
    validator.SelectField = _SelectField;
}());
...
(function()
{
    ...
    Y.extend(_PasswordField,validator.TextBaseField,{
        /**
    ...
    validator.PasswordField = _PasswordField;
}());
...
(function()
{
    ...
    Y.extend(_CheckboxField,validator.BaseInputField,{
        /**
        ...
        showNoIndicators:function(){
            ...
            YD.removeClass(dom,this.get('incorrectCss'));
            YD.removeClass(dom,this.get('correctCss'));
            if (correctIndicator !== null && correctIndicator !== undefined){
                correctIndicator.style.display = 'none';
            }
            if (incorrectIndicator !== null && incorrectIndicator !== undefined){
        ...
        checkIndicators:function(){
            ...
            if (!this.get('isOn')){
                ...
                if (dom !== null && dom !== undefined){
                    YD.removeClass(dom,this.get('incorrectCss'));
                    YD.addClass(dom,this.get('correctCss'));
                }
                if (correctIndicator !== null && correctIndicator !== undefined){
                    correctIndicator.style.display = '';
                }
                ...
                if (dom !== null && dom !== undefined){
                    YD.addClass(dom,this.get('incorrectCss'));
                    YD.removeClass(dom,this.get('correctCss'));
                }
                if (correctIndicator !== null && correctIndicator !== undefined){
                    correctIndicator.style.display = 'none';
        ...
        initializeEvents:function(target){
            ...
            YE.addListener(this.get('inputDOM'),'click',theTarget._evtOnChange,theTarget,true);
        }
    });
    validator.CheckboxField = _CheckboxField;
})();
...
(function()
{
    ...
    _CustomField.ATTRS = {
        ...
        /**
         * Optional id value for identifying the custom input in the validator
         * @config id
         * @type any
         */
        id:{
    ...
    Y.extend(_CustomField,validator.BaseInputField,{
        /**
    ...
    validator.CustomField = _CustomField;
}());

YAHOO.register("validator", YAHOO.widget.Validator, {version: "@VERSION@", build: "@BUILD@"});
